...
func (x *AddProductToCartResponse) GetBaseResponse() *common.BaseResponse {
	if x != nil {
...
func (x *ListCartResponse) GetBaseResponse() *common.BaseResponse {
	if x != nil {
		return x.BaseResponse
	}
	return nil
...
func (x *DeleteCartResponse) GetBaseResponse() *common.BaseResponse {
	if x != nil {
		return x.BaseResponse
	}
	return nil
...
func (x *UpdateCartQuantityResponse) GetBaseResponse() *common.BaseResponse {
	if x != nil {
		return x.BaseResponse
	}
	return nil
...
const file_cart_cart_proto_rawDesc = "" +
	...
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\tproductId\"e\n" +
	"\x18AddProductToCartResponse\x129\n" +
	...
	"\bquantity\x18\x06 \x01(\x03R\bquantity\"\x7f\n" +
	...
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\x06cartId\"O\n" +
	"\x12DeleteCartResponse\x129\n" +
	"\rbase_response\x18\x01 \x01(\v2\x14.common.BaseResponseR\fbaseResponse\"l\n" +
	"\x19UpdateCartQuantityRequest\x12#\n" +
	"\acart_id\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x10\x01\x18\xff\x01R\x06cartId\x12*\n" +
	"\fnew_quantity\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x00R\vnewQuantity\"W\n" +
	"\x1aUpdateCartQuantityResponse\x129\n" +
	"\rbase_response\x18\x01 \x01(\v2\x14.common.BaseResponseR\fbaseResponse2\xb5\x02\n" +
	"\vCartService\x12Q\n" +
	...
	"\x12UpdateCartQuantity\x12\x1f.cart.UpdateCartQuantityRequest\x1a .cart.UpdateCartQuantityResponseB6Z4github.com/kucingscript/go-grpc-ecommerce-be/pb/cartb\x06proto3"
...
var file_cart_cart_proto_depIdxs = []int32{
	9, // 0: cart.AddProductToCartResponse.base_response:type_name -> common.BaseResponse
	9, // 1: cart.ListCartResponse.base_response:type_name -> common.BaseResponse
	3, // 2: cart.ListCartResponse.items:type_name -> cart.ListCartResponseItem
	9, // 3: cart.DeleteCartResponse.base_response:type_name -> common.BaseResponse
	9, // 4: cart.UpdateCartQuantityResponse.base_response:type_name -> common.BaseResponse
